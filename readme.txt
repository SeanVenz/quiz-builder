...
1. Create your quiz in the admin area
2. Add questions with multiple choice answers
3. Set point values for each answer
4. Configure quiz settings (randomization, pagination, etc.)
5. Use the [quiz_builder quiz_id="1"] shortcode to display your quiz
6. View and export results from the admin dashboard
...
4. Follow the getting started guide to create your first quiz
5. Use the [quiz_builder quiz_id="X"] shortcode to display quizzes on your pages or posts
